...
"my-building": {
  ...
  refImage: "assets/image-refs/my-building.png",
  sprites: {
...
See [scripts/ASSET_PIPELINE.md](scripts/ASSET_PIPELINE.md) for an explanation of the full autonomous asset generation pipeline.
...
Use Nano Banana to generate an isometric reference image to turn into a 3D model.

### 2. Convert to 3D

We use fal.ai's Trellis 2 API to generate a 3D model from the 2D image generated by Nano Banana.
